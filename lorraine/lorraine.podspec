Pod::Spec.new do |spec|
    ...
    if !Dir.exist?('build/cocoapods/framework/Lorraine.framework') || Dir.empty?('build/cocoapods/framework/Lorraine.framework')
        raise "

        Kotlin framework 'Lorraine' doesn't exist yet, so a proper Xcode project can't be generated.
        'pod install' should be executed after running ':generateDummyFramework' Gradle task:

            ./gradlew :lorraine:generateDummyFramework
